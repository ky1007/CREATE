...
var render = function render(words) {
  ...
  if (stringLength <= 16) {
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(0, 5)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(5, 11)));
    return (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(11)));
  }
  if (stringLength <= 23) {
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(0, 5)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(5, 11)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(11, 16)));
    return (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(16)));
  }
  if (stringLength <= 29) {
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(0, 5)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(5, 11)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(11, 18)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(18, 23)));
    return (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(23)));
  }
  if (stringLength <= 35) {
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(0, 5)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(5, 11)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(11, 18)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(18, 23)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(23, 29)));
    return (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(29)));
  }
  if (stringLength <= 42) {
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(0, 5)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(5, 11)));
    ...
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(18, 23)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(23, 29)));
    (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(29, 35)));
    return (0, _shape_determination2.default)((0, _shape_probabilties2.default)(words.slice(35)));
  }
};
...
var Triangle = exports.Triangle = function Triangle(x, y, width, color) {
...
var shapeDetermination = exports.shapeDetermination = function shapeDetermination(properties) {
  ...
  switch (shape) {
    ...
    case 'triangle':
      var newFakeSquare = new _shapes.Square(xAvg, yAvg, sizeAvg, color, opacityAvg);
